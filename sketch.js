...
function draw() {
  ...
  for (var i = 0; i < 1; i++) { //this loop is required after the loop command in set-up. 
...
function Particle(x, y) {
  ...
  this.update = function() {
    this.x = random(20,600);
    this.y = random(20,500); // -20 makes it easier to fill the left side of the canvas
  }
  ...
  this.show = function() {
    ...
    textSize(12) 
    text(random(QUOTES), this.x, this.y); //elt the texts to randomly generated on canvas
